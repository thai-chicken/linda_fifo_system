...
#include "../common/TuplePatternElem.h"
...
Tuple tup1 =
    createTuple({"1", "abc", "3.1415", "d", "*"}, {ElemType::INT, ElemType::STRING, ElemType::FLOAT, ElemType::STRING, ElemType::EMPTY}, 4);
Tuple tup2 =
    createTuple({"10", "abc", "3.1415", "*", "*"}, {ElemType::INT, ElemType::STRING, ElemType::FLOAT, ElemType::EMPTY, ElemType::EMPTY}, 3);
Tuple tup3 =
    createTuple({"2", "3", "1", "Ala ma kota", "*"}, {ElemType::INT, ElemType::INT, ElemType::INT, ElemType::STRING, ElemType::EMPTY}, 4);

// Wzorce z tresci zadania
TuplePattern tp1 =
    createTuplePattern({"1", "*", "*", "d", "*"}, {ElemType::INT, ElemType::STRING, ElemType::FLOAT, ElemType::STRING, ElemType::EMPTY},
                       {MatchCondition::EQUAL, MatchCondition::ANY, MatchCondition::ANY, MatchCondition::EQUAL, MatchCondition::ANY}, 4);
TuplePattern tp2 =
    createTuplePattern({"0", "abc", "*", "*", "*"}, {ElemType::INT, ElemType::STRING, ElemType::FLOAT, ElemType::EMPTY, ElemType::EMPTY},
